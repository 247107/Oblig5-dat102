...
import java.util.*;
import static no.hvl.dat102.Utils.*;
...
public class Klient {
	...
	public static KjedetBinaerSokeTre<Integer> genereringTre(int size, int max) {
	...
	private static void flereTre() {
		...
		for (int i = 0; i < ANTALL_TRAER; i++) {
			KjedetBinaerSokeTre<Integer> bs = genereringTre(ANTALL_NODER, MAKS_VERDI);
